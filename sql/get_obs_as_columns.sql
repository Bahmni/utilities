--set @concept_names="'HEIGHT', 'WEIGHT'";
--call temp_proc('2014-09-01', '2014-09-04', @concept_names);

DELIMITER //
CREATE PROCEDURE get_obs_as_columns(IN start_date date, IN end_date date, IN conceptNames varchar(50))
  BEGIN
    SET @sql = NULL;
    ...
    select  GROUP_CONCAT(DISTINCT
       ...
       from obs 
       join concept_name as cn on cn.concept_id = obs.concept_id and cn.name in (conceptNames);
